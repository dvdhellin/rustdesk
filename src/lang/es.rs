...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red RedSión en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que Asistencia Remota RedSión no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar Asistencia Remota RedSión a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Asistencia Remota RedSión de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Asistencia Remota RedSión de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que Asistencia Remota RedSión use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [Asistencia Remota RedSión Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Dejar Asistencia Remota RedSión como Servicio en 2do plano"),
        ...
        ("Show RustDesk", "Mostrar Asistencia Remota RedSión"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a Asistencia Remota RedSión permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a Asistencia Remota RedSión permisos de \"Grabar Audio\"."),
        ...
        ("verify_rustdesk_password_tip", "Verificar la contraseña de Asistencia Remota RedSión"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses Asistencia Remota RedSión e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "¡Por favor, actualiza Asistencia Remota RedSión Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que Asistencia Remota RedSión no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de RedSión"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de Asistencia Remota RedSión de fondo"),
        ...
        ("About RustDesk", "Acerca de Asistencia Remota RedSión"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Por favor, actualiza el cliente Asistencia Remota RedSión a la versión {} o superior en el lado remoto"),
